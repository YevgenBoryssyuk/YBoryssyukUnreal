...
void ABP_Character::PossessedBy(AController* NewController)
{
...
void ABP_Character::OnRep_PlayerState()
{
...
UAbilitySystemComponent* ABP_Character::GetAbilitySystemComponent() const
{
